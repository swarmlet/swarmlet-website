...
\> [More on how Swarmlet works](/docs/getting-started/deploying-applications)  
<!-- \> [Swarmlet CLI commands](/docs/cli/commands)   -->
:::
...
During the installation you can choose to install [Matomo](https://matomo.org/), [Portainer](https://www.portainer.io/), [Swarmpit](https://swarmpit.io) and [Swarmprom](https://github.com/stefanprodan/swarmprom).  
...
1. Use an existing project, or clone one of the [examples](https://github.com/swarmlet/swarmlet/tree/master/examples)
...
> [Example application setup and deployment guide](/docs/getting-started/deploying-applications#example-app-setup)
